...
fn main() {
        ...
        && target_cpu != Some("native".into())
    {
        ...
        // the feature enabled failed at configure time. The two blocks were
        // written independently and never reconciled; `target-cpu=native` is the
        // only value that skipped this one, and it is unusable for a distributed
